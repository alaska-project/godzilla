...
namespace Godzilla.AspNetCore
{
    public static class AspNetCoreDependencyInjectionExtensions
    {
        public static IEntityContextServiceCollection<TContext> AddEntityContextAuthorization<TContext>(IEntityContextServiceCollection<TContext> services)
